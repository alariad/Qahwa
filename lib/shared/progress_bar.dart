...
import 'package:flutterapp1/services/models.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (report != null) {
      ...
      if (completed != null && completed.contains(quizId)) {
        return Icon(FontAwesomeIcons.coffee, color: Colors.brown);
      } else {
        return Icon(FontAwesomeIcons.coffee, color: Colors.grey);
      }
    } else {
      return Icon(FontAwesomeIcons.coffee, color: Colors.grey);
    }
